...
Note that the packages are also loaded with the same commands in the R Markdown file contained in the [template zip file](https://github.com/OferEngel/SO/blob/origin/backup/Lab%2002/YOUR-NAME-HERE-Lab-02.zip).
