...
Note that the packages are also loaded with the same commands in the R Markdown file contained in the template zip file.
...
The data frame we will be working with today is called `datasaurus_dozen` and it is in the `datasauRus` package. Actually, this single data frame contains 13 datasets, all lumped together. Each of the datasets has a different 
